        ...
        *,
        ...
        if deep_research:
            system_prompt = (
                ...
                "Дай глубокий структурированный ответ, опираясь на найденные фрагменты. "
                "Если данных в заметках недостаточно, явно обозначь границы уверенности. "
            ...
            system_prompt = (
                ...
                "Если контекст нерелевантен или отсутствует, честно скажи об этом и предложи, как уточнить запрос."
            )
        user_prompt = (
            ...
            "Сформируй структурированный, понятный и полезный ответ."
        )
