import {Title, Stack, Progress, Group, Button, Text, Paper, Box, LoadingOverlay, Select } from '@mantine/core';
...
export const IndexPage = () => {
    ...
    // Инициализация vault_id из первого доступного волта
    useEffect(() => {
                ...
                {selectedVaultId ? (
                    ...
                    <Text c="dimmed" ta="center" py="xl">
                        {availableVaults.length === 0 
                            ? "No vaults available. Please upload a vault first."
                            : "Please select a vault to view its index."}
                    </Text>
                )}
            </Stack>
        </BasicLayout>
